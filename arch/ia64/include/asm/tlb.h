...
#define tlb_delay_rmap(tlb) do { } while (0)
#endif
#ifndef tlb_flush_rmaps
#define tlb_flush_rmaps(tlb, vma) do { } while (0)
#endif
#ifndef tlb_change_page_size
#define tlb_change_page_size(tlb, page_size) do { } while (0)
#endif
#ifndef tlb_remove_tlb_entries
#define tlb_remove_tlb_entries(tlb, ptep, nr, page_size) do { } while (0)
#endif
#ifndef __tlb_remove_folio_pages
#define __tlb_remove_folio_pages(tlb, page, nr, flags) do { } while (0)
#endif
#ifndef tlb_free_vmas
#define tlb_free_vmas(tlb) do { } while (0)
#endif
